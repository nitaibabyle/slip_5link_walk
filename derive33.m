...
syms q1 q2 qd1 qd2 qdd1 qdd2 'real' % joint angle, angular rate and acceleration
syms l1 l2 a1 a2 'real'             % CoM distance relative to parent joint and link length
syms m1 m2 mmm 'real'     % mass of links and motors
syms I1_1  I1_12 I1_13 I1_12 I1_2  I1_23 I1_13 I1_23 I1_3 I2_1 I2_12 I2_13 I2_12 I2_2  I2_23 I2_13 I2_23 I2_3 'real'     % inertia moment of links and motors
...
% kinematic energy
KE = 0.5 * m1 * dot(V_l1, V_l1) + 0.5 *m2 * dot(V_l2, V_l2)+0.5*mmm*dot(V_mmm,V_mmm) + 0.5 * W_l1' * I_l1_w * W_l1 + 0.5 * W_l2' * I_l2_w * W_l2;

% potential energy
pg1=PG1(1:3);
pg2=PG2(1:3);
PE = m1 * g * PG1(2) + m2 * g * PG2(2)+mmm*g*P2(2);
